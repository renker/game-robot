...
public class ImageUtils1 {
	...
	public static void main(String[] args) throws IOException {
		grayImage(1, "D:/screenImage/gray.png", "D:/screenImage/result-gray1.png");// 最大值法灰度化
//		grayImage(2, "D:/screenImage/source.png", "D:/screenImage/source-gray2.png");// 最小值法灰度化
//		grayImage(3, "D:/screenImage/source.png", "D:/screenImage/source-gray3.png");// 平均值法灰度化
//		grayImage(4, "D:/screenImage/source.png", "D:/screenImage/source-gray4.png");// 加权法灰度化
	}
	 ...
	 * 
	 * @param status
	 *            灰度化方法的种类，1表示最大值法，2表示最小值法，3表示均值法，4加权法
	 * @param imagePath
	 *            需要灰度化的图片的位置
	 * @param outPath
	 *            灰度化处理后生成的新的灰度图片的存放的位置
	 * @throws IOException
	 */
